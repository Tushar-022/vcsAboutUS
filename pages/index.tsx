...
export default function Home() {
  ...
  return (
    <Layout>
      {/* <div className="bg-gradient-radial from-[#f4f6f7] via-[#e7e9e9] to-[#f1f4f4] w-[80vw] h-[120vh] absolute top-0"> */}
      <div className="bg-gradient-radial from-[#f4f6f7] via-[#e7e9e9] to-[#f1f4f4] w-[80vw] h-[60vh] absolute top-0">
      </div>
      {/* hero section */}
      {/* <VideoModal /> */}
      <div className="text-center z-10  px-3 max-w-sm sm:max-w-3xl space-y-4">
        <h1 className="my-8 bg-gradient-to-br from-[#8269e6] via-[#5a57e2] to-[#803ff1] bg-clip-text text-center text-4xl font-bold tracking-tight text-transparent md:text-7xl">
          <Balancer ratio={0.6}>Transforming Virtual Customer Service</Balancer>
        </h1>
        <p className="md:text-xl text-lg text-neutral-700">
        Our virtual customer service offers multilingual support, consistent information, follow-up and resolution tracking,
         emotion tracking, 24/7 availability, 
        and significant societal impacts including stress reduction, 
        increased accessibility, customer satisfaction, globalization, scalability, cost reduction, and increased capacity.
        </p>
      </div>
