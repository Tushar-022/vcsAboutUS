...
export default function Demo() {
  ...
  return (
    ...
    //   <p className="md:text-2 xl text-lg font-bold">Have you taken the demo of the website?</p>
    //   {demoTaken === null && (
    //     <div className="flex gap-4">
    //     <button
    //       onClick={handleYesClick}
    //       className="px-6 py-3 rounded-lg font-bold hover:scale-105 transition-all bg-gradient-to-br from-[#FF7F50] to-[#FF4500] text-white hover:from-[#FFA07A] hover:to-[#FF6347]"
    //     >
    //       Yes
    //     </button>
    //     <button
    //       onClick={handleNoClick}
    //       className="px-6 py-3 rounded-lg font-bold hover:scale-105 transition-all bg-gradient-to-br from-[#ADD8E6] to-[#4682B4] text-white hover:from-[#87CEEB] hover:to-[#1E90FF]"
    //     >
    //       No
    //     </button>
    //   </div>
